            ...
            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item">
                        <img src={carousel1} class="bd-placeholder-img bd-placeholder-img-lg d-block w-100" width="800" height="400"/>
                        <div class="carousel-caption d-none d-md-block bg-light rounded text-dark">
                    ...
                    <div class="carousel-item active">
                        <img src={carousel2} class="bd-placeholder-img bd-placeholder-img-lg d-block w-100" width="800" height="400"/>
                        <div class="carousel-caption d-none d-md-block bg-light rounded text-dark">
                            <h5>Did you know that</h5>
                    ...
                    <div class="carousel-item">
                        <img src={carousel3} class="bd-placeholder-img bd-placeholder-img-lg d-block w-100" width="800" height="400"/>
                        <div class="carousel-caption d-none d-md-block bg-light rounded text-dark">
                            <h5>Did you know that</h5>
            ...
            <div className="card-deck p-5 mt-5 text-center row bg-dark">
                ...
                <div className="col">
                    <div className="card mb-4 box-shadow">
                        ...
                        <div className="card-body">
                            ...
                            <button type="button" class="btn btn-lg btn-block btn-outline-primary" data-bs-toggle="modal" data-bs-target="#signUpModal">
                                Sign up for free
                            </button>
                        </div>
                    </div>
                ...
                <div className="col">
                    <div className="card mb-4 box-shadow">
                        ...
                        <div className="card-body">
                            <h1 className="card-title pricing-card-title">$9.99 <small class="text-muted">/ year</small></h1>
                            <h2>Be a pro</h2>
                            <ul className="list-unstyled mt-3 mb-4">
                                <li>Up to 5 business</li>
                                <li>100 GB of storage</li>
                ...
                <div className="col">
                    <div className="card mb-4 box-shadow">
                        ...
                        <div className="card-body">
                            <h1 className="card-title pricing-card-title">$49.99 <small class="text-muted">/ 5 years</small></h1>
                            <h2>Best Deal</h2>
                            <ul className="list-unstyled mt-3 mb-4">
